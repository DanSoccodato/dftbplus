...
c----+|-----------------------------------------------------------------------|
     ...
     +kcycle,iprer,ipost,intpol
      ...
      real phic(0:ncx+1,0:ncy+1,0:ncz+1)
...
c----+|-----------------------------------------------------------------------|
      ...
      real cof(nx,ny,nz,8)
      real tx(nx,ny,nz,*),ty(ny,nx,nz,*),tz(nz,nx,ny,*)
      real wk(*)
      integer intl,nxa,nxb,nyc,nyd,nze,nzf,ixp,jyq,kzr,iex,jey,kez,
     +nfx,nfy,nfz,iguess,maxcy,method,meth2,nwork,lwork,itero,
     +kcycle,iprer,ipost,intpol
     ...
     +kcycle,iprer,ipost,intpol
      ...
      common/mud3c/kpbgn(50),kcbgn(50),ktxbgn(50),ktybgn(50),
     +ktzbgn(50),nxk(50),nyk(50),nzk(50),ngrid,klevel,kcur,kps
      real dlx,dly,dlz,dlx2,dly2,dlz2,dlxx,dlyy,dlzz,cmin
      real cemax,alfmax
      real cxx,cyy,czz,cx,cy,cz,ce,alfa,gbdy,x,y,z,c1,c2,c3
      real c4,c5,c6
...
c----+|-----------------------------------------------------------------------|
     ...
     +ktzbgn(50),nxk(50),nyk(50),nzk(50),ngrid,klevel,kcur,kps
      ...
      real cxx,cyy,czz,cx,cy,cz,ce,alfa,gbdy,x,y,z,c1,c2,
     +c3,c4,c5,c6
