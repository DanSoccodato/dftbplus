 ...
 */
typedef void (*ExtPotFunc)(void *refptr, float *dqatom, float *extpotatom);
 ...
 */
typedef void (*ExtPotGradFunc)(void *refptr, float *dqatom, float *extpotatomgrad);
 ...
 *     calculate forces.
 */
void dftbp_set_external_potential(DftbPlus *instance, const float *extpot,
                                  const float *extpotgrad);
 ...
 */
void dftbp_set_coords(DftbPlus *instance, const float *coords);
 ...
 */
void dftbp_set_coords_and_lattice_vecs(DftbPlus *instance, const float *coords,
                                       const float *latvecs);
 ...
 */
void dftbp_set_coords_lattice_origin(DftbPlus *instance, const float *coords,
                                       const float *latvecs, const float *origin);
 ...
 */
void dftbp_get_energy(DftbPlus *instance, float *mermin_energy);
 ...
 */
void dftbp_get_gradients(DftbPlus *instance, float *gradients);
 ...
 */
void dftbp_get_stress_tensor(DftbPlus *instance, float *stresstensor);
 ...
 */
void dftbp_get_gross_charges(DftbPlus *instance, float *charges);
 ...
 */
void dftbp_get_elstat_potential(DftbPlus *instance, int nLocations, float *potential, const float *locations);
