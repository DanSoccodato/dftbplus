...
99030   format ('Linear dependent system in linear equation solver dgesv,', &
  ...
  subroutine gesv_complex(aa, bb, nEquation, nSolution, iError)
    ...
    info = 0
    allocate(ipiv(nn))
    call cgesv(nn, nrhs, aa, lda, ipiv, bb, ldb, info)
