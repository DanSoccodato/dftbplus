 ...
 *     Pass NULL if not available.
 */
void dftbp_write_autotest_tag(int n_atom, int n_ext_charge, int n_pot_locations, float mermin_energy, float *gradients,
                              float *stress_tensor, float *gross_charges, float * ext_charge_gradients, float *potential);
